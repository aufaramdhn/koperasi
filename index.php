...
<head>
  ...
  <title>Koperasi - Makmur Mandiri</title>
  ...
  <link rel="stylesheet" href="assets/landing-page/css/line-icons.css" />
  <link rel="stylesheet" href="assets/landing-page/css/owl.carousel.css" />
  <link rel="stylesheet" href="assets/landing-page/css/owl.theme.css" />
  <link rel="stylesheet" href="assets/landing-page/css/nivo-lightbox.css" />
  <link rel="stylesheet" href="assets/landing-page/css/magnific-popup.css" />
  <link rel="stylesheet" href="assets/landing-page/css/slicknav.css" />
  <link rel="stylesheet" href="assets/landing-page/css/animate.css" />
  <link rel="stylesheet" href="assets/landing-page/css/main.css" />
...
<body>
  ...
  <header id="hero-area" data-stellar-background-ratio="0.5">
    ...
    <nav class="navbar navbar-expand-lg fixed-top scrolling-navbar indigo">
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="main-navbar">
          <ul class="mr-auto navbar-nav w-100 justify-content-end">
            ...
            <li class="nav-item">
              <a class="nav-link page-scroll" href="views/auth/login.php">Login</a>
            </li>
          </ul>
        </div>
      </div>
      ...
      <ul class="mobile-menu">
        ...
        <li>
          <a class="page-scroll" href="#services">Tentang Kami</a>
        </li>
        <li>
        ...
        <li>
          <a class="page-scroll active" href="views/auth/login.php">Login</a>
        </li>
      </ul>
      <!-- Mobile Menu End -->
    </nav>
        ...
        <div class="col-md-10">
          <div class="text-center contents">
            <h1 class="wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="0.3s">
              Koperasi Simpan Pinjam <br /> Makmur Mandiri
            </h1>
            <p class="lead wow fadeIn" data-wow-duration="1000ms" data-wow-delay="400ms">
              Koperasi yang menyediakan simpanan dan pinjaman dengan jangka waktu panjang dengan bunga yang rendah
            </p>
            <a href="views/auth/register.php" class="btn btn-common wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="400ms">Daftar Sekarang</a>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-md-4 col-sm-6">
          <div class="item-boxes wow fadeInDown" data-wow-delay="0.2s">
            ...
            <h4>Aman</h4>
            <p>
              Sudah banyak anggota yang mempercayakan penghasilannya kepada kami
            </p>
          </div>
        </div>
        <div class="col-md-4 col-sm-6">
    ...
    <div class="container">
      ...
      <div class="row">
            ...
            <div class="row">
              <div class="col-lg-6 col-sm-6 col-xs-12 box-item">
                ...
                <div class="text">
                  <h4>Layanan Cepat</h4>
                  <p>
                    Setelah proses, data akan langsung dicek dan dikonfirmasi oleh admin.
                  </p>
                </div>
              </div>
              <div class="col-lg-6 col-sm-6 col-xs-12 box-item">
                ...
                <div class="text">
                  <h4>Terpecaya</h4>
                  <p>
                    Jaminan 100% uang kembali, akan diarahkan oleh CS.
                  </p>
                </div>
              </div>
              <div class="col-lg-6 col-sm-6 col-xs-12 box-item">
                ...
                <div class="text">
                  <h4>Aman</h4>
                  <p>
                    Data anda 100% aman, privasi utama bagi pengguna.
                  </p>
                </div>
              </div>
              <div class="col-lg-6 col-sm-6 col-xs-12 box-item">
                ...
                <div class="text">
                  ...
                  <p>
                    Mudah digunakan untuk para pengguna handphone, tampilan mudah dimengerti.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div class="col-lg-4 col-xs-12">
          <div class="show-box">
            <img class="img-fulid" src="assets/landing-page/img/features/feature.png" alt="" />
          </div>
        </div>
      </div>
    </div>
          ...
          <div id="portfolio" class="row">
            ...
            >
              <div class="portfolio-item">
                <div class="shot-item">
                  <img
                    src="assets/landing-page/img/portfolio/img1.jpg"
                    alt=""
                  />
                  <a
                    class="overlay lightbox"
                    href="assets/landing-page/img/portfolio/img1.jpg"
                  >
            ...
            <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4 mix design print">
              <div class="portfolio-item">
                <div class="shot-item">
                  <img
                    src="assets/landing-page/img/portfolio/img2.jpg"
                    alt=""
                  />
                  <a
                    class="overlay lightbox"
                    href="assets/landing-page/img/portfolio/img2.jpg"
                  >
                    <i class="lnr lnr-eye item-icon"></i>
                  </a>
                </div>
            ...
            <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4 mix development">
              <div class="portfolio-item">
                <div class="shot-item">
                  <img
                    src="assets/landing-page/img/portfolio/img3.jpg"
                    alt=""
                  />
                  <a
                    class="overlay lightbox"
                    href="assets/landing-page/img/portfolio/img3.jpg"
                  >
                    <i class="lnr lnr-eye item-icon"></i>
                  </a>
                </div>
            ...
            >
              <div class="portfolio-item">
                <div class="shot-item">
                  <img
                    src="assets/landing-page/img/portfolio/img4.jpg"
                    alt=""
                  />
                  <a
                    class="overlay lightbox"
                    href="assets/landing-page/img/portfolio/img4.jpg"
                  >
                    <i class="lnr lnr-eye item-icon"></i>
                  </a>
                </div>
            ...
            <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4 mix development">
              <div class="portfolio-item">
                <div class="shot-item">
                  <img
                    src="assets/landing-page/img/portfolio/img5.jpg"
                    alt=""
                  />
                  <a
                    class="overlay lightbox"
                    href="assets/landing-page/img/portfolio/img5.jpg"
                  >
                    <i class="lnr lnr-eye item-icon"></i>
                  </a>
                </div>
            ...
            <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4 mix print design">
              <div class="portfolio-item">
                <div class="shot-item">
                  <img
                    src="assets/landing-page/img/portfolio/img6.jpg"
                    alt=""
                  />
                  <a
                    class="overlay lightbox"
                    href="assets/landing-page/img/portfolio/img6.jpg"
                  >
                    <i class="lnr lnr-eye item-icon"></i>
                  </a>
                </div>
      ...
      <div class="row">
        <div class="col-lg-3 col-md-6 col-xs-12">
          <div class="single-team">
            <img src="assets/landing-page/img/team/team-1.jpg" alt="" />
        ...
        <div class="col-lg-3 col-md-6 col-xs-12">
          <div class="single-team">
            <img src="assets/landing-page/img/team/team-2.jpg" alt="" />
            <div class="team-details">
              <div class="team-inner">
        ...
        <div class="col-lg-3 col-md-6 col-xs-12">
          <div class="single-team">
            <img src="assets/landing-page/img/team/team-3.jpg" alt="" />
            <div class="team-details">
              <div class="team-inner">
        ...
        <div class="col-lg-3 col-md-6 col-xs-12">
          <div class="single-team">
            <img class="img-fulid" src="assets/landing-page/img/team/team-4.jpg" alt="" />
            <div class="team-details">
              <div class="team-inner">
        ...
        <div class="col-md-12">
          <div class="touch-slider owl-carousel owl-theme">
            <div class="testimonial-item">
              <img src="assets/landing-page/img/testimonial/customer1.jpg" alt="Client Testimonoal" />
            ...
            <div class="testimonial-item">
              <img src="assets/landing-page/img/testimonial/customer2.jpg" alt="Client Testimonoal" />
              <div class="testimonial-text">
                <p>
                  Terpercaya
                </p>
            ...
            <div class="testimonial-item">
              <img src="assets/landing-page/img/testimonial/customer3.jpg" alt="Client Testimonoal" />
              <div class="testimonial-text">
                <p>
                  Mudah digunakan
                </p>
            ...
            <div class="testimonial-item">
              <img src="assets/landing-page/img/testimonial/customer4.jpg" alt="Client Testimonoal" />
              <div class="testimonial-text">
                <p>
                  Layanan Cepat
                </p>
        ...
        <div class="row">
            ...
            <div class="blog-item-wrapper">
              <div class="blog-item-img">
                <a href="single-post.html">
                  <img src="assets/landing-page/img/blog/img1.jpg" alt="" />
                </a>
              </div>
              <div class="blog-item-text">
                ...
                <a href="single-post.html" class="btn-rm"
                  >Read More <i class="lnr lnr-arrow-right"></i
                ></a>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 blog-item">
            ...
            <div class="blog-item-wrapper">
              <div class="blog-item-img">
                <a href="single-post.html">
                  <img src="assets/landing-page/img/blog/img2.jpg" alt="" />
                </a>
              </div>
              <div class="blog-item-text">
                <div class="meta-tags">
          ...
          <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 blog-item">
            ...
            <div class="blog-item-wrapper">
              <div class="blog-item-img">
                <a href="single-post.html">
                  <img src="assets/landing-page/img/blog/img3.jpg" alt="" />
                </a>
              </div>
              <div class="blog-item-text">
                <div class="meta-tags">
  ...
  <script src="assets/landing-page/js/jquery-min.js"></script>
  <script src="assets/landing-page/js/popper.min.js"></script>
  <script src="assets/landing-page/js/bootstrap.min.js"></script>
  <script src="assets/landing-page/js/jquery.mixitup.js"></script>
  <script src="assets/landing-page/js/nivo-lightbox.js"></script>
  <script src="assets/landing-page/js/owl.carousel.js"></script>
  <script src="assets/landing-page/js/jquery.stellar.min.js"></script>
  <script src="assets/landing-page/js/jquery.nav.js"></script>
  <script src="assets/landing-page/js/scrolling-nav.js"></script>
  <script src="assets/landing-page/js/jquery.easing.min.js"></script>
  <script src="assets/landing-page/js/smoothscroll.js"></script>
  <script src="assets/landing-page/js/jquery.slicknav.js"></script>
  <script src="assets/landing-page/js/wow.js"></script>
  <script src="assets/landing-page/js/jquery.vide.js"></script>
  ...
  <script src="assets/landing-page/js/form-validator.min.js"></script>
  <script src="assets/landing-page/js/contact-form-script.js"></script>
